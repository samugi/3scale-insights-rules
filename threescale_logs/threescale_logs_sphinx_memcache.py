...
@rule(ThreescaleLogsParserSystemSphinx)
def check_standard_logs_system_sphinx(content):
    failed= []
    passed = []
...
@rule(ThreescaleLogsParserSystemMemcache)
def check_standard_logs_system_memcache(content):
    failed= []
    passed = []
