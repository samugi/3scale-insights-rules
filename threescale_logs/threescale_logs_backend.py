...
@rule(ThreescaleLogsParserBackendWorker)
def check_standard_logs_backend_worker(content):
    failed= []
    passed = []
...
@rule(ThreescaleLogsParserBackendListener)
def check_standard_logs_backend_listener(content):
    failed= []
    passed = []
...
@rule(ThreescaleLogsParserBackendCron)
def check_standard_logs_backend_cron(content):
    failed= []
    passed = []
