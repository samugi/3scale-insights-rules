...
def check_standard_logs(results):
    failed_staging = []
    passed_staging = []
    failed_production = []
    passed_production = []
    ...
    failed_staging, passed_staging = log_utils.evaluate_logs(content_staging)
    failed_production, passed_production = log_utils.evaluate_logs(content_production)
